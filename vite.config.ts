  ...
  plugins: [
    monkey({
      ...
      userscript: {
        ...
        namespace: "https://github.com/cyrahs/cd2-vcbs-offline",
        description: "在 VCB-Studio 项目页一键把种子添加到 CloudDrive2 离线下载并检查任务状态",
        author: "cyrahs",
        homepageURL: "https://github.com/cyrahs/cd2-vcbs-offline",
        supportURL: "https://github.com/cyrahs/cd2-vcbs-offline/issues",
